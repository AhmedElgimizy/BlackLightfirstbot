...
『BL!google/للبحث في قوقل عن طريق الدسكورد』
『BL!prems/يعرض لك برمشناتك بالسيرفر』
『BL!yn/تسأل بوت والبوت يجاوبك بنعم او لا』
『BL!w/امر يخليك مثل بوت تكتب عبره مع امر ويسويك بوت』
『BL!za5/يزخرف لك كلمة او جملة』
『BL!rooms/يعرض لك كل الرومات الي بالسيرفر مع عددها』
『BL!roles/يعرض لك كل الرانكات بالسيرفر بشكل جميل』
『BL!say/يكرر الكلام الي تكتبو』
『BL!image/صورة السيرفر』
『BL!members/��عرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص』
『BL!id/معلومات عنك』
『BL!profile/عرض بروفايل حقك』
『BL!tc/انشاء روم مؤقت ويمكنك تحديد الاعدادات』
『BL!ban / عدد الاشخاص المبندة 』
『BL!voice /  يوم لك بكتابه مجموع عدد الاشخاص الموجودين برومات』
『BL!avatar/صورتك او صورة الي تمنشنو』
『BL!embed/يكرر الي تقولو بشكل حلو』
『BL!discrim/كود يضهر لك الاشخاص نفس تاقك』
『BL!emoji <any things>/لتحويل اي كلمه تقولها الي ايموجي』
『BL!invite/لدعوة البوت الى سيرفرك』
『BL!support/سيرفر الدعم』
『BL!contact/ارسال اقتراح او لمراسلة صاحب البوت』
**
  `
,`
        ***__Administrative Orders__***
**
『BL!move @user /  لسحب الشخص الى روومك』
『BL!voiceonline /  لتفعيل خاصيه فويس اونلاين يسحب عدد الاشخاص موجودين برومات』
          ...
          .then(co => {
            text = co.first().content
              ...
              message.channel.send(`تم حفظ اقتراحك الرجاء انتضار الرد من قبل الاداره`)
                client.channels.get("493540753734369280").send(`${message.author.username}'s sug => ${text}`)
...
client.on('guildMemberRemove', Sal => { //By Salto7#4595
  ...
  .setColor('RED')
  .setFooter(Sal.guild.name, Sal.guild.iconURL, true)
  var channel =Sal.guild.channels.find('name', 'Leave') // هنا حط اسم الروم الي تبيه يكتب فيه
  if (!channel) return;
  channel.send({embed : embed});
  }); 
